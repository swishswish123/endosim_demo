...
def camera_to_mri(Cam_T_Endo, Cam_T_PatRef, PatRef_T_MRI, Hand_T_Eye, point_in_camera_coords=[0, 0, 0]):
    """
    ...
    """
    transform = np.linalg.inv(PatRef_T_MRI) @ np.linalg.inv(Cam_T_PatRef) @ Cam_T_Endo @ Hand_T_Eye
